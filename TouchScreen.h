...
#define aXM 33  // analog input pin connected to LCD_CS 
//#define aYP 35  // analog input pin connected to LCD_RS
#define aYP 15  // analog input pin connected to LCD_RS
#else
...
class TouchScreen {
 public:
  TouchScreen(uint8_t xp, uint8_t yp, uint8_t xm, uint8_t ym, uint16_t rx, int layout);
